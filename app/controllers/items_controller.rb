class ItemsController < ApplicationController
  ...
  layout 'item_application', only: [:new, :edit]
    ...
    def index
      ...
      @items_lady =  @items.item_num(ladies_grand_child_ids)
      ...
      @items_men =  @items.item_num(mens_grand_child_ids)
      ...
      @items_baby =  @items.item_num(baby_grand__child_ids)
      ...
      @items_cosme =  @items.item_num(cosmes_grand__child_ids)
