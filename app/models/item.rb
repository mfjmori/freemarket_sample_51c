...
# enum postage: {unanswered:0, seller_cost:1, buyer_cost: 2
# }

# enum shipping_method: {unanswered:0, mitei: 1, rakuraku: 2, yuu: 3, letter: 4, normal: 5, cat: 6, pack: 7, post: 8, packet: 9
#   }

# enum shipping_date: {unanswered:0, two:1, three:2, seven:3
# }

# enum condition: {unanswered:0, new:1, new_like:2, no_dirt:3, less_dirt: 4, dirt: 5, bad: 6
# }
